 ...
 * `apograph migrate` calls — so the schema under test is the real shipped schema,
 ...
 * that is load-bearing rather than stylistic: `apograph.config.ts` reads
