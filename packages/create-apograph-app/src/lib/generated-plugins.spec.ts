...
/**
 * **`create-apograph-app:I-16`, the registration half.**
 *
 ...
 * with an authentication error that reads as an Apograph bug. An unconfigured SSO
...
/** What a stubbed `@apograph/*` module hands back for any named export. */
interface Stub {
...
/**
 * Renders the app and evaluates its `plugins.ts` with every `@apograph/*`
 * import stubbed.
 *
...
describe('copilotProviders in the rendered app', () => {
    ...
    it('registers nothing when no key is set [create-apograph-app:I-16]', () => {
    ...
    it('registers only the backend whose key is set [create-apograph-app:I-16]', () => {
    ...
    it('registers both, Claude first, when both are set [create-apograph-app:I-16]', () => {
    ...
    it('cannot register a backend the app was not generated with [create-apograph-app:I-16]', () => {
...
describe('ssoProviders in the rendered app', () => {
    ...
    it('registers nothing when the provider is unconfigured [create-apograph-app:I-16]', () => {
        // `apograph.config.ts` omits the key when the issuer or client id is
    ...
    describe.each([
        ...
        it('registers it under its own name, built by its own adapter [create-apograph-app:I-16]', () => {
        ...
        it('is absent when this provider alone is unconfigured [create-apograph-app:I-16]', () => {
    ...
    it('registers it under its own name once configured [create-apograph-app:I-16]', () => {
