...
import { WYSIWYG_MEDIA_SLOT } from '@ortha/wysiwyg-admin';
import {
 ...
 * (owned by `@ortha/workspaces-admin`). Register it after
...
export function MediaPlugin(): MediaAdminPlugin {
    return {
        ...
        slots: [
            ...
            // (`@ortha/wysiwyg-admin`) declares `WYSIWYG_MEDIA_SLOT` and
