...
import { MEDIA_ASSET_RESOLVER } from '@ortha/content-server';
...
import { COPILOT_ATTACHMENT_RESOLVER } from '@ortha/copilot-domain';
    ...
    static forRoot(options: MediaModuleOptions): DynamicModule {
        ...
        return {
            ...
            exports: [
                ...
                // assets in and out of the library — `@ortha/transfer-server`
