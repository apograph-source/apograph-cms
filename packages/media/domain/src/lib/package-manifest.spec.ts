 ...
 * behind `@apograph/media-server`, so `npm i @apograph/media-provider-s3`
 ...
 */
describe('@apograph/media-domain package manifest', () => {
    ...
    it('is the package it claims to be', () => {
        expect(manifest.name).toBe('@apograph/media-domain');
    });
