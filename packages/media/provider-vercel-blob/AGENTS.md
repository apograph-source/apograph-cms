...
`npx nx test @ortha/media-provider-vercel-blob` runs the shared contract plus
...
- `npx nx test @ortha/media-provider-vercel-blob` /
  `npx nx typecheck @ortha/media-provider-vercel-blob` /
  `npx nx lint @ortha/media-provider-vercel-blob`
