...
/**
 * **`create-orthacms-app:I-16`, the registration half.**
 *
 ...
 * with an authentication error that reads as an Ortha CMS bug. An unconfigured SSO
...
describe('copilotProviders in the rendered app', () => {
    ...
    it('registers nothing when no key is set [create-orthacms-app:I-16]', () => {
    ...
    it('registers only the backend whose key is set [create-orthacms-app:I-16]', () => {
    ...
    it('registers both, Claude first, when both are set [create-orthacms-app:I-16]', () => {
    ...
    it('cannot register a backend the app was not generated with [create-orthacms-app:I-16]', () => {
...
describe('ssoProviders in the rendered app', () => {
    ...
    it('registers nothing when the provider is unconfigured [create-orthacms-app:I-16]', () => {
        // `orthacms.config.ts` omits the key when the issuer or client id is
    ...
    describe.each([
        ...
        it('registers it under its own name, built by its own adapter [create-orthacms-app:I-16]', () => {
        ...
        it('is absent when this provider alone is unconfigured [create-orthacms-app:I-16]', () => {
    ...
    it('registers it under its own name once configured [create-orthacms-app:I-16]', () => {
