...
describe('the templates directory', () => {
    ...
    ])('is excluded from %s [create-orthacms-app:I-31]', (_name, read) => {
        expect(read()).toMatch(/packages\/create-orthacms-app\/templates/);
    });

    it('is excluded from the TypeScript build [create-orthacms-app:I-31]', () => {
...
describe('the package itself', () => {
     ...
     */
    it('installs nothing to run [create-orthacms-app:I-32]', () => {
