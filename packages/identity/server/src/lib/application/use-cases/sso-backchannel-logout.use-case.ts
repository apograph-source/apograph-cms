...
/**
 * Ends Ortha CMS sessions because the identity provider says the person's session
 * there has ended.
 *
 ...
 *
 * - **A `sid`** names one provider session, and only the Ortha CMS sessions opened
