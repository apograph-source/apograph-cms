 ...
 * `X-Orthacms-Signature: t=<unix seconds>,v1=<hex>`. The timestamp is **inside**
...
export const SIGNATURE_HEADER = 'x-orthacms-signature';
...
/** The full `X-Orthacms-Signature` header value for one delivery. */
