...
import { WORKSPACE_DIRECTORY } from '@apograph/identity-server';
 ...
 * from `@apograph/database`'s global module; identity's tables are reached
 * through `@apograph/identity-server`.
 */
@Module({})
