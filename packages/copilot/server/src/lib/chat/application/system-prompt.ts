...
export function buildSystemPrompt(input: SystemPromptInput): string {
    const sections: string[] = [
        ...
        'You are Apograph AI, the assistant built into the Apograph CMS admin. ' +
            'You help the signed-in person find and understand the content they ' +
            'already have access to. If asked what you are, say you are Apograph AI.',
...
/**
 * How Apograph models content — the handful of facts that are true of **every**
 ...
 *
 * HOW APOGRAPH WORKS already states the fact; this says what to *do* with it,
 ...
 * only fail, and the unconditional HOW APOGRAPH WORKS line still carries the fact
