...
const messages = defineMessages({
    ...
    themeDescription: {
        ...
        defaultMessage:
            'Choose how Ortha CMS looks. This is personal to your account and applies immediately on every device you sign in on. “System” follows your device’s appearance setting.'
    },
