 ...
 * Both were accepted and ignored here: `orthacms dev --server` parsed, brought
...
export async function devCommand(
    ...
    if (!options.serverOnly) {
        ...
        // Without an admin, `orthacms dev` runs the API and says nothing — but
        // `orthacms dev --admin` asked for the admin and nothing else, and
