        ...
        >
            ...
            <InsetTopBarContext.Provider value={barHost}>
                ...
                <div
                    ...
                    className="flex min-h-0 flex-1 flex-col overflow-y-auto pb-[var(--apograph-fixed-bottom-gutter,0px)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset focus-visible:outline-none"
                >
                    {children}
                </div>
