...
module.exports = {
    ...
    //
    // `@apograph/*` is consumed from source — the manifests' `exports` point
    // at `./src/index.ts` — so a `require('@apograph/bootstrap-server')` left
    ...
    // `@apograph/nx` infers one onto every `packages/*` project for the
