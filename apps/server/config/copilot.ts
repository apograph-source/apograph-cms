 ...
 */
export interface OrthaCmsCopilotConfig extends CopilotPluginConfig {
    /**
...
export function copilotConfig(): OrthaCmsCopilotConfig {
    return defined({
 ...
 */
function copilotProviders(): OrthaCmsCopilotConfig['providers'] {
