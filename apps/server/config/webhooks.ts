 ...
 *
 * Only the four values a deployment genuinely varies are env-sourced; the rest
 * are left to the plugin's own defaults, which is where the reasoning behind
 ...
 * internet-facing one must not have.
 */
