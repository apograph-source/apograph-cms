...
Two extension points, both declared with `createSlot` from `@apograph/utils-admin`:
...
From the owning plugin's factory; it needs a dependency on `@apograph/insights-admin` — the same direction as for any slot filler:

| Step | What the contributor does                                                                                                                     |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Adds `@apograph/insights-admin` to its own `package.json` dependencies                                                                        |
...
1. **The owning package adds a dependency** on `@apograph/insights-admin`.
