...
- **It taught the wrong thing about authority.** Users reasonably read "Ortha CMS AI
  needs your approval" as "Ortha CMS AI could otherwise do more than you can". The
...
- The product behaves the way its own copy already described: Ortha CMS AI does what
...
- **Move the opt-in to host config** (`orthacms.config.ts`, beside the model
