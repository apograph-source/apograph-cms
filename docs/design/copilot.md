...
> ## Naming: the product is **Ortha CMS AI**, the code is `copilot`
>
> Every string a user reads says **Ortha CMS AI** — the panel title, the sidebar
...
A copilot is only as good as the structured surface it can act on. Ortha CMS already
...
| Runtime provider config   | none     | All config is env-only via `orthacms.config.ts`. First DB-persisted settings and first encrypted-secret-at-rest in the codebase; needs a key in config and a rotation story.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
